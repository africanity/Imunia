...
import { MapPin, Users, Activity, TrendingUp, Building2, AlertTriangle, BarChart3, Package, ChevronRight } from "lucide-react";
              ...
              <tbody>
                {stats.districtStats.map((district, idx) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      <div className="text-gray-700">{district.totalChildren.toLocaleString()}</div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="font-medium text-gray-900">{district.vaccinations.toLocaleString()}</div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-gray-700">{district.coverage.toFixed(1)}%</span>
                      </div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="text-gray-700">{district.agentsCount}</div>
                    </td>
                    <td className="py-4 px-4">
